...
att_train_train_loader = torch.utils.data.DataLoader(att_train_train, batch_size=10, shuffle=True, num_workers=2)
att_train_test_loader = torch.utils.data.DataLoader(att_train_test, batch_size=10, shuffle=True, num_workers=2)
# att_val_train_loader = torch.utils.data.DataLoader(att_val_train, batch_size=10, shuffle=False, num_workers=2)
# att_val_test_loader = torch.utils.data.DataLoader(att_val_test, batch_size=10, shuffle=False, num_workers=2)
att_test_train_loader =  torch.utils.data.DataLoader(att_test_train, batch_size=10, shuffle=True, num_workers=2)
att_test_test_loader = torch.utils.data.DataLoader(att_test_test, batch_size=10, shuffle=True, num_workers=2)
